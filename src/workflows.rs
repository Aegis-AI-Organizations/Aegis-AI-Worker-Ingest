...
use temporalio_sdk::{WorkflowContext, WorkflowContextView, WorkflowResult, ActivityOptions};
...
impl IngestTopologyWorkflow {
    ...
    pub async fn run(
        ...
        let payload_json: String = ctx.start_activity(
        ...
        Ok(format!("Successfully ingested topology for file {}/{}", bucket, key))
    }
}
